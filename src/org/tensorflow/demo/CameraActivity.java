...
//FrameLayout container;
  ...
  public class Picture implements Camera.PictureCallback{
    ...
    public void onPictureTaken(byte[] bytes, Camera camera) {
      System.out.println("캡쳐하였습니다.");

      Bitmap bitmap = BitmapFactory.decodeByteArray(bytes, 0,bytes.length);
      image = resizeBitmap(bitmap);
      ByteArrayOutputStream stream = new ByteArrayOutputStream();
      image.compress(Bitmap.CompressFormat.JPEG, 100, stream);
      byteArray = stream.toByteArray();
      System.out.println(" 바이트 길이 = " + byteArray.length);
      //-------------------------------------이 부분----------------------------------------------
      createImageTable();

      finish();
      int length = 5;
      Intent intent = new Intent(CameraActivity.this, CapturedActivity.class);
    ...
    public void createImageTable(){
      ...
      String sql = "create table if not exists SendImage"+
              "(_id integer PRIMARY KEY autoincrement," +
              " image blob not null)";
      db.execSQL(sql);
      System.out.println("이미지 테이블 생성");
      ...
      System.out.println("데이터베이스에 이미지 추가");
...
/*
    if (useCamera2API) {
      ...
      System.out.println("useCamera2APi!!!");
    } else {    */
    fragment =
            new LegacyCameraConnectionFragment(this, getLayoutId(), getDesiredPreviewFrameSize());
    //camera = ((LegacyCameraConnectionFragment) fragment).camera;
    System.out.println("Lecacy!!!");
    //  }
